...
var userDataRef = firebase.database().ref(mail).child(tname).child(branch).child(subject).child("TotalDate").orderByKey();
...
/*  
  document.writeln("<br><h4>key</h4>");
   document.writeln("<hr>");	
   document.writeln("<br><h4>childData"+key+"</h4>");
   document.writeln("<hr>");	
   document.writeln("<br><h4>"+childData+"</h4>");
   document.writeln("<hr>");	
  */ 
   ...
   var table = document.createElement('table');
	...
	var text2 = document.createTextNode(childData);
